...
public class CoursSummary extends JavaScriptObject {
    ...
    public final native String setClubId(String club_id) /*-{ this.club_id = club_id; }-*/;
    public final native String getSession() /*-{ return this.session_seqno; }-*/;
    public final native String setSession(String session_seqno) /*-{ this.session_seqno = session_seqno; }-*/;
    public final native String getShortDesc() /*-{ return this.short_desc; }-*/;
    public final native String setShortDesc(String short_desc) /*-{ this.short_desc = short_desc; }-*/;
